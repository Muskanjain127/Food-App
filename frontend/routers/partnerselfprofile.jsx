...
export function Partnerselfprofile() {
  ...
  useEffect(() => {
    const fetchfoodpartner = async () => {
      const partnerr = await axios.get(
        `http://localhost:5000/foodpartner/find`,
        {
          withCredentials: true,
        },
      );
      console.log("dataaaaaaaa", partnerr.data);
      setfoodpartner(partnerr.data);
      console.log("parner", foodpartner);
    };
    fetchfoodpartner();
  }, []);
        ...
        >
          <div className="flex justify-center p-8 pt-8 pb-2  ">
            <div className="relative w-32 h-32">
              <img
                src={
                  foodpartner.profilepic && foodpartner.profilepic.trim() !== ""
          ...
          <div className="flex  rounded-2xl gap-1 m-2 mb-3  justify-center">
            <button
              ...
              onClick={() =>
                navigate(`/foodpartner/edit/profile/${foodpartner._id}`, {
                  state: { foodpartner },
                })
              }
            >
